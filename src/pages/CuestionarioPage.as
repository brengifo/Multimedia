package pages
{
	...
	public class CuestionarioPage extends AbstractPage
	{	
		public var contenido_mc:MovieClip;
		private var content_nav_mc:MovieClip;
		private var ClassReference:Class;
		
		public function CuestionarioPage()
		{
			super();
			alpha = 0;
			//new Scaffold(this);
			navSelect("cuestionario.Page1");
			//transitionIn();
		}
		...
		override public function transitionIn():void 
		{
			...
			TweenMax.to(contenido_mc, 0.3, { x:0, ease:Quad.easeOut, delay:.3 } );
				try 
			{
				MovieClip(Gaia.api.getPage(Pages.NAV).content).sfxPlay("swap");
			} catch (e:Error) {
